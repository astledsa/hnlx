...
size_t HNSW::get_node_by_distance(const std::vector<size_t> &nodes, std::vector<Vector> q, Dist dist)
{
    ...
    this->Time[HNSWFunctions::sub::gnbd].push_back(
        std::chrono::duration<double>(std::chrono::high_resolution_clock::now() - start_initial_search_loop).count());
...
// 1
// --- HNSW Function Average Time Report ---
// GetNodeByDistance 0.0015959 ms 0.550586 ms
// SearchNeighbour 0.0449147 ms 0.449147 ms
// SearchLayer 0.0582841 ms 1.16568 ms
// Insert 0.0165615 ms 1.63959 ms
// CosineDist: No data collected.
// bidirectionalConn 3.53007e-06 ms 0.001585 ms
// ------------------------------------------